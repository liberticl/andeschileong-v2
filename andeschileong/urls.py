...
urlpatterns = [
    ...
    path('logout/',
         ...
         name='logout'),
    path('recursos/', views.welcome, name='welcome'),
    path('recursos/ciudadespendientes/', include('ciudadespendientes.urls')),
    path('recursos/licitaciones/', include('licitaciones.urls')),
    path('recursos/mediciones/', include('apps.mediciones.urls')),
